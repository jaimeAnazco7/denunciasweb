...
{
    public partial class DenunciaA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtMotivo.Attributes.Add("maxlength", txtMotivo.MaxLength.ToString());

            txtMotivo.Text = "";
            txtMotivo.MaxLength = 160;
            txtMotivo.Attributes.Add("maxlength", txtMotivo.MaxLength.ToString());
           ...
           // cnx_2.ConnectionString = "Data Source=serverprod;Initial Catalog=BDDigemid;Persist Security Info=True;User ID=usrAppdenuncia;Password=Ykn42Ks3Wf";
            ...
            if (!Page.IsPostBack)
            {
               ...
               //SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\Database.mdf;Integrated Security=True;User Instance=True");
                ...
                //SqlCommand cmd1 = new SqlCommand("SELECT * FROM [tb_tipoProducto]", con);
                ...
                //ddlTipoProducto1.DataSource = dt1;
                //ddlTipoProducto1.DataBind();
        ...
        //{
        //    if (!(chkFalsificados1.Select || chkVencidos1.Selected ))
        //        args.IsValid = false;
        //}
...

        {
            ...
            {
                string fileName = Path.GetFileName(fileUploadA.PostedFile.FileName);
                string uploadPath = @"d:\DenunciaImagenes\" + fileName;
                fileUploadA.SaveAs(uploadPath);
            }



            //if (btnEnviarDenuncia.Text == "Salir")
            //{
            //    Response.Redirect("DefaultCI.aspx");
            //}
            ...
            #region COMENTE PARA OCULTA IMAGENES -- DEBO TERMINARLO
          ...
          //  cnx_2.ConnectionString = "Data Source=serverprod;Initial Catalog=BDDigemid;Persist Security Info=True;User ID=usrAppdenuncia;Password=Ykn42Ks3Wf";
            ...
            cmd_2.Parameters.Add("@ESTNUMEINS2_25", SqlDbType.VarChar).Value = "";
            ...
            cmd_2.Parameters.Add("@DENDIRECCION2_33", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENURBANIZ2_34", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENDIRENUME2_35", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENINTERIOR2_36", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@UBICODIGO2_37", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENNUMETLF2_38", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENFAX2_39", SqlDbType.VarChar).Value = "";
            cmd_2.Parameters.Add("@DENEMAIL2_40", SqlDbType.VarChar).Value = "";
...
#region Correo
           ...
           // smtp.Credentials = new NetworkCredential("ahorromed@minsa.gob.pe", "D1gemid2018");
            ...
            mail.To.Add(new MailAddress("jaimeanazco@gmail.com"));
         ...
         && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false))
              ...
              && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false))
                  ...
                  && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = true))
                {
                  ...
                  && (chksinRS1.Selected = true) && (chkProdPublico1.Selected = true))
                {
            ...
            if (chkMalEstado1.Selected)
            {
                ...
                if ((chkFalsificados1.Selected) && (chkVencidos1.Selected) && (chkProcDesconocida1.Selected) && (chkRotAdulterado1.Selected) && (chksinRS1.Selected)
                   && (chkProdPublico1.Selected) && (chkMuestraMedica1.Selected))
                {
                    ...
                    ocho = 8;
                      ...
                      && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = false))
                {
                    ...
                    && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = false))
                {
                    ...
                    && (chksinRS1.Selected = true) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = false))
                {
                    ...
                    && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = true) && (chkMuestraMedica1.Selected = false))
                {
                    ...
                    && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = true))
                {
                    ...
                    && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = true))
                {
                    ...
                    && (chksinRS1.Selected = true) && (chkProdPublico1.Selected = true) && (chkMuestraMedica1.Selected = false))
                {
                    ...
                    && (chksinRS1.Selected = true) && (chkProdPublico1.Selected = false) && (chkMuestraMedica1.Selected = true))
                {
                   ...
                   && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = true) && (chkMuestraMedica1.Selected = true))
                {
                    ...
                    && (chksinRS1.Selected = false) && (chkProdPublico1.Selected = true) && (chkMuestraMedica1.Selected = true))
                {
                   ...
                   && (chksinRS1.Selected = true) && (chkProdPublico1.Selected = true) && (chkMuestraMedica1.Selected = true))
                {
            ...
            MessageBox.Show(Page,"Su denuncia se generó correctamente");
            //  btnEnviarDenuncia.Text = "Salir";
           // Response.Redirect("DefaultCI.aspx");

            //var myStringVariable = "Registrado correctamente";
