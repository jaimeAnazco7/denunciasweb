<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DenunciaP_DU.aspx.cs" Inherits="denunciasWeb.DenunciaP_DU" %>
...
function setState() {
  ...
  //}
   ...
   <div class="page-header">
        <h1>DENUNCIAS EN LÍNEA &nbsp &nbsp &nbsp 
            ...
            <br />
            <br />
            <h4>DENUNCIA A BOTICA, FARMACIA O FARMACIA DE ESTABLECIMIENTO DE SALUD PRIVADO POR NO CONTAR CON MEDICAMENTOS ESENCIALES GENÉRICOS CONTENIDOS EN EL LISTADO DE LA R.M. N° 1097-2019/MINSA (D.U. N° 007-2019, D.S. N° 026-2019-SA)  </h4></h1>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li ><a href="DenunciaA_DU">Anónima</a></li>
      <li class="active"><a href="DenunciaP_DU">Persona Natural</a></li>
