...
{
    public partial class DenunciaA_DU : System.Web.UI.Page
    {
...

        {
           ...
           // SqlConnection cnx_2 = new SqlConnection();
            ...
            // cnx_2.ConnectionString = @"Data Source = Digemid556\MSSQLSERVER2018; Initial Catalog = db_denunciasWeb; Persist Security Info = True; User ID = sa; Password = J@m09679933";
          ...
          //  cnx_2.ConnectionString = @"Data Source = 192.168.78.27\MSSQLSERVER2018; Initial Catalog = db_denunciasWeb; Persist Security Info = True; User ID = sa; Password = J@m09679933";
           ...
           cmd_2.Parameters.Add("@DENFECHDEN_3", SqlDbType.DateTime).Value = Convert.ToDateTime(this.txtFechaRegistro.Text);
            ...
            cmd_2.Parameters.Add("@DENINDIANON2_24", SqlDbType.Int).Value = anonimo;  /* DICE INT Y EN LA BASE ES CHAR   */
