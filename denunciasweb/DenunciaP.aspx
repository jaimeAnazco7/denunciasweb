<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DenunciaP.aspx.cs" Inherits="denunciasWeb.DenunciaP" %>
...
//}
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="DenunciaP">Persona Natural</a></li>
...
<div class="panel-group" id="accordion">
  ...
  <div class="panel panel-default">
   ...
   <%--    <div id="collapse2" class="panel-collapse collapse in'<%= state %>'">--%> 
      <div class="panel-body">
          ...
          <div class="datosPersonaNatural" style="display: flex; justify-content: space-between; flex-direction:column;  width: 100%;">
                        <div class="form-group" style="margin-right: 10px;">
                            ...
                            <asp:TextBox ID="txtNombreApellidos" class="form-control" runat="server" required></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label31" For="txtDNI" Font-Bold="True" runat="server" Text="DNI"></asp:Label>
                            <asp:TextBox ID="txtDNI" class="form-control" runat="server"  required></asp:TextBox>
                        </div>
                        <br />  
                         <div class="form-group">
                    ...
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlDepartamentoPN" Style="width: 280px;" class="form-control" runat="server"  AutoPostBack="True"
                             ...
                             <asp:Label ID="lblError4" runat="server" ForeColor="#f4a827"  style =" font-weight: bold; " Text=""></asp:Label>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblError5" runat="server" ForeColor="#f4a827"  style =" font-weight: bold; " Text=""></asp:Label>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlDistritoPN" Style="width: 280px;" class="form-control" runat="server" AppendDataBoundItems="true" DataTextField="disdescrip"
                             ...
                             <asp:Label ID="lblError6" ForeColor="#f4a827"  style =" font-weight: bold; " runat="server" Text=""></asp:Label>
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="descrip_tipoPersona" DataValueField="id_tipoPersona">
        ...
        (check list, se puede seleccionar 1 o más de 1)
                ...
                <div class="form-group">
                    ...
                    <asp:Label ID="Label4" for="txtRegSan" Font-Bold="True" ForeColor="Gray" runat="server" Text="Si no cuenta con Registro Sanitario ingrese SIN RS"    ></asp:Label>
                ...
                <tr>
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblError1" runat="server" ForeColor="#f4a827"  style =" font-weight: bold; " Text=""></asp:Label>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblError2" runat="server" ForeColor="#f4a827"  style =" font-weight: bold; " Text=""></asp:Label>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td class="style1">
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblError3" runat="server" ForeColor="#f4a827"  style =" font-weight: bold; " Text=""></asp:Label>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
        ...
        <asp:ValidationSummary ID="vldChexckboxes"  ForeColor="#f4a827"  style =" font-weight: bold; "       runat="server" />
