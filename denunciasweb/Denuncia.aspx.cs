...
namespace denunciasWeb
{
    ...
    public partial class Denuncia : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          //  SqlConnection cnx_2 = new SqlConnection();
           ...
           // cnx_2.ConnectionString = "Data Source=serverprod;Initial Catalog=BDDigemid;Persist Security Info=True;User ID=usrAppdenuncia;Password=Ykn42Ks3Wf";
            ...
            if (!Page.IsPostBack)
            {ddltipoPersona.Attributes.Add("onchange", "showhide(this);");
        ...
        protected void ddltipoPersona_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // ddltipoPersona.SelectedItem.Text     o   .value
            ...
            if (ddltipoPersona.SelectedItem.Text == "Anónimo")
            {
            ...
            //}
            //else if (DropDownList1.SelectedItem.Value == "Anónimo")  //DropDownList5.SelectedItem.Value
            //{
...

        {
          ...
          //  cnx_2.ConnectionString = "Data Source=serverprod;Initial Catalog=BDDigemid;Persist Security Info=True;User ID=usrAppdenuncia;Password=Ykn42Ks3Wf";
            ...
            cmd_2.Parameters.Add("@DENTIPODEN2_23", SqlDbType.VarChar).Value = this.ddltipoPersona.SelectedValue; ;
